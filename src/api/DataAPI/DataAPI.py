...
###
# It is extencion of the methods used to manage the data of a Data object to apply commons methods.
###
@library
class DataAPI_ext:
    ...
    def create_from_data(self, dict ):
        raise Exception( "It is necesary to create a create_from_data() method for " + self.__class__.__name__ )
    ###
    ...
    # -param objA(DataObj) : It is the first quotes to be compared.
    # -param objB(DataObj) :It is the second Quote to be compared.
    ###
    @keyword
